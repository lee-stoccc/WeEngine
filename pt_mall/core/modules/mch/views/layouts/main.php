...
<div class="sidebar" style="display: none">
    <div class="sidebar-nav">
        <div class="sidebar-logo" style="">
            ...
            <div style="font-size: .85rem;color: #bbb;margin-top: 10px;">
                <a>版本: v<?= $this->context->version ?></a>
        ...
        <div class="nav-group">
            ...
            <div class="sub-nav-list">
				<a href="<?= $urlManager->createUrl(['mch/miaosha/index']) ?>">秒杀管理</a>
				<a href="<?= $urlManager->createUrl(['mch/group/goods/index']) ?>">拼团管理</a>
				<a href="<?= $urlManager->createUrl(['mch/book/goods/index']) ?>">预约管理</a>
            </div>
        </div>
    </div>
</div>
<?php if ($this->params['is_group'] == '1'): ?>
    <div class="sidebar sidebar-tow">
        <div class="sidebar-nav">
            <div class="sidebar-logo" style="">
                <a href="<?= $urlManager->createUrl(['mch/group/goods/index']) ?>"
...
<?php if ($this->params['is_book'] == '1'): ?>
    <div class="sidebar sidebar-tow">
        <div class="sidebar-nav">
            <div class="sidebar-logo" style="">
                <a href="<?= $urlManager->createUrl(['mch/book/goods/index']) ?>"

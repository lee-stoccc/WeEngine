    ...
    function utf82gb($utfstr) {
        ...
        if (empty($UC2GBTABLE)) {
           ...
           // $filename = __DAT__ . "/gb2312-utf8.dat";
            $filename = MODULE_ROOT."/resource/dat/gb2312-utf8.dat";
            $fp = fopen($filename, "r");
            while ($l = fgets($fp, 15)) {
...
if (!function_exists('big52gb')) {
    ...
    function big52gb($Text) {
        ...
        if (empty($BIG5_DATA)) {
            ...
            $filename = MODULE_ROOT . "/resource/dat/big5-gb.dat";
...
if (!function_exists('gb2big5')) {
    ...
    function gb2big5($Text) {
        ...
        if (empty($GB_DATA)) {
            ...
            $filename = MODULE_ROOT . "/resource/dat/gb-big5.dat";
            $fp = fopen($filename, "rb");
...
if (!function_exists('unicodeUrl2Gbk')) {
    ...
    function unicodeUrl2Gbk($str) {
        ...
        if (!isset($GLOBALS['GbkUniDic'])) {
            $fp = fopen(MODULE_ROOT.'/resource/dat/gbk-unicode.dat', 'rb');
            /*$fp = fopen(MODULE_ROOT. "/gbk-unicode.dat", 'rb');*/
            while (!feof($fp)) {

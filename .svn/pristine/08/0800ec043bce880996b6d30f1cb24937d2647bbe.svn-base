//验证数字
function Fit_Numbers(s) {
    var patrn = /^-?(0|[1-9]\d*|[1-9]\d*\.\d*|0\.\d*[1-9]\d*)$/;
    if (!patrn.exec(s)) return false;
    return true;
}

//验证日期格式
function Fit_IsDate(s) {
...
function formNoCheck(obj) {
    obj.value = "请稍等..";
    obj.disabled = true;
    return true;
}
//是滞中文
function Fit_checkCnStr(str){ 
// [\u4E00-\uFA29]|[\uE7C7-\uE7F3]汉字编码范围
//|[a-zA-Z0-9]
...
return m男　e女
*/
function Fit_isMaleOrFemale(sId){
return sId.substr(16,1)%2?"m":"e";
}
     //获取年龄
function Fit_calcAge(UUserCard){

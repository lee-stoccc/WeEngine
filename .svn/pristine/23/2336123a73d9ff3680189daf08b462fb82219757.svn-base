            ...
            <table class="table table-bordered bg-white">
                <tr>
                    <td colspan="5">
                        ...
                        <span>团长：<span class="badge badge-pill badge-warning"><?= $order_item['nickname'] ?></span></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="order-tab-5">
                        <a class="btn btn-sm btn-primary" href="<?= $urlManager->createUrl(['mch/group/order/group-list','pid'=>$order_item['id']]); ?>">团信息</a>
                    </td>
                </tr>
            </table>
        </div>

...
CREATE TABLE IF NOT EXISTS `ims_tg_discuss` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=60 DEFAULT CHARSET=utf8 COMMENT='评论表';
...
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品的营销';
...
if(pdo_tableexists('tg_category')) {
	if(!pdo_fieldexists('tg_category',  'open')) {
		pdo_query("ALTER TABLE ".tablename('tg_category')." ADD `open` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
...
if(pdo_tableexists('tg_discuss')) {
	if(!pdo_fieldexists('tg_discuss',  'merchantid')) {
		pdo_query("ALTER TABLE ".tablename('tg_discuss')." ADD `merchantid` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
if(pdo_tableexists('tg_discuss')) {
	if(!pdo_fieldexists('tg_discuss',  'star')) {
		pdo_query("ALTER TABLE ".tablename('tg_discuss')." ADD `star` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
if(pdo_tableexists('tg_discuss')) {
	if(!pdo_fieldexists('tg_discuss',  'orderid')) {
		pdo_query("ALTER TABLE ".tablename('tg_discuss')." ADD `orderid` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
if(pdo_tableexists('tg_discuss')) {
	if(!pdo_fieldexists('tg_discuss',  'storereply')) {
		pdo_query("ALTER TABLE ".tablename('tg_discuss')." ADD `storereply` varchar(445)    COMMENT '';");
	}	
}
...
if(pdo_tableexists('tg_goods')) {
	if(!pdo_fieldexists('tg_goods',  'hexiao_id')) {
		pdo_query("ALTER TABLE ".tablename('tg_goods')." ADD `hexiao_id` text    COMMENT '';");
	}	
}
if(pdo_tableexists('tg_goods')) {
...
if(pdo_tableexists('tg_goods')) {
	if(!pdo_fieldexists('tg_goods',  'share_group')) {
		pdo_query("ALTER TABLE ".tablename('tg_goods')." ADD `share_group` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
if(pdo_tableexists('tg_goods')) {
	if(!pdo_fieldexists('tg_goods',  'hexiaolimittimetype')) {
		pdo_query("ALTER TABLE ".tablename('tg_goods')." ADD `hexiaolimittimetype` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
if(pdo_tableexists('tg_goods')) {
	if(!pdo_fieldexists('tg_goods',  'share_image_group')) {
		pdo_query("ALTER TABLE ".tablename('tg_goods')." ADD `share_image_group` varchar(445)    COMMENT '';");
	}	
}
if(pdo_tableexists('tg_goods')) {
	if(!pdo_fieldexists('tg_goods',  'share_title_group')) {
		pdo_query("ALTER TABLE ".tablename('tg_goods')." ADD `share_title_group` varchar(445)    COMMENT '';");
	}	
}
if(pdo_tableexists('tg_goods')) {
	if(!pdo_fieldexists('tg_goods',  'share_desc_group')) {
		pdo_query("ALTER TABLE ".tablename('tg_goods')." ADD `share_desc_group` text    COMMENT '';");
	}	
}
if(pdo_tableexists('tg_goods')) {
...
if(pdo_tableexists('tg_goods')) {
	if(!pdo_fieldexists('tg_goods',  'is_own')) {
		pdo_query("ALTER TABLE ".tablename('tg_goods')." ADD `is_own` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
if(pdo_tableexists('tg_goods')) {
	if(!pdo_fieldexists('tg_goods',  'noticetime')) {
		pdo_query("ALTER TABLE ".tablename('tg_goods')." ADD `noticetime` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
if(pdo_tableexists('tg_goods')) {
	if(!pdo_fieldexists('tg_goods',  'is_norefund')) {
		pdo_query("ALTER TABLE ".tablename('tg_goods')." ADD `is_norefund` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
if(pdo_tableexists('tg_goods')) {
	if(!pdo_fieldexists('tg_goods',  'stockstatus')) {
		pdo_query("ALTER TABLE ".tablename('tg_goods')." ADD `stockstatus` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
if(pdo_tableexists('tg_goods')) {
	if(!pdo_fieldexists('tg_goods',  'forcegroup')) {
		pdo_query("ALTER TABLE ".tablename('tg_goods')." ADD `forcegroup` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
...
if(pdo_tableexists('tg_group')) {
	if(!pdo_fieldexists('tg_group',  'iftip')) {
		pdo_query("ALTER TABLE ".tablename('tg_group')." ADD `iftip` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
...
if(pdo_tableexists('tg_lottery')) {
	if(!pdo_fieldexists('tg_lottery',  'pattern')) {
		pdo_query("ALTER TABLE ".tablename('tg_lottery')." ADD `pattern` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
if(pdo_tableexists('tg_lottery')) {
	if(!pdo_fieldexists('tg_lottery',  'ceshi')) {
		pdo_query("ALTER TABLE ".tablename('tg_lottery')." ADD `ceshi` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
...
if(pdo_tableexists('tg_merchant')) {
	if(!pdo_fieldexists('tg_merchant',  'kefuimg')) {
		pdo_query("ALTER TABLE ".tablename('tg_merchant')." ADD `kefuimg` varchar(225)    COMMENT '';");
	}	
}
...
if(pdo_tableexists('tg_order')) {
	if(!pdo_fieldexists('tg_order',  'limitnotice')) {
		pdo_query("ALTER TABLE ".tablename('tg_order')." ADD `limitnotice` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
if(pdo_tableexists('tg_order')) {
	if(!pdo_fieldexists('tg_order',  'uid')) {
		pdo_query("ALTER TABLE ".tablename('tg_order')." ADD `uid` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
if(pdo_tableexists('tg_order')) {
	if(!pdo_fieldexists('tg_order',  'mid')) {
		pdo_query("ALTER TABLE ".tablename('tg_order')." ADD `mid` int(11)   DEFAULT 0 COMMENT '';");
	}	
}
...
if(pdo_tableexists('tg_store')) {
	if(!pdo_fieldexists('tg_store',  'storehours')) {
		pdo_query("ALTER TABLE ".tablename('tg_store')." ADD `storehours` varchar(100)    COMMENT '';");
	}	
}
...
if(pdo_tableexists('tg_user_node')) {
	if(!pdo_fieldexists('tg_user_node',  'flag')) {
		pdo_query("ALTER TABLE ".tablename('tg_user_node')." ADD `flag` int(11)   DEFAULT 0 COMMENT '';");
	}	
}

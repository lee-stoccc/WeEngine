...
//            return false;
        ...
        $return_xml = $this->_requestPost($api,$xml);
        return DataTransform::xmlToArray($return_xml);
    }

    private function _requestPost($url, $data, $ssl = true, $header = null, $cookie = false, $do_header = false)
    {
        // curl完成
        $curl = curl_init();
